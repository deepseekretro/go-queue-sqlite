...
<header>
  ...
  <div style="margin-left:auto;display:flex;align-items:center;gap:12px;">
    ...
    <a href="/static/cache_dashboard.html" style="font-size:.8rem;padding:5px 12px;background:#1e293b;border:1px solid #0e7490;color:#22d3ee;border-radius:6px;text-decoration:none;" target="_blank">🗃 Cache Dashboard</a>
